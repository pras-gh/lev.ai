...
</html>`}e.s(["buildMonthlySummaryHtml",()=>g,"computeMonthlySummary",()=>f]),r()}catch(e){r(e)}},!1),65547,e=>e.a(async(t,r)=>{try{var a=e.i(83181),s=e.i(86903),i=e.i(79661),n=e.i(21902),o=e.i(51837),c=t([a,s,i,n,o]);function u(e){let t=new Headers;for(let r of(t.set("content-type","application/json"),["authorization","x-supabase-access-token","x-access-token","cookie"])){let a=e.headers.get(r);a&&t.set(r,a)}return t}function d(e){if(!e)return 0;let t=Date.parse(e);return Number.isNaN(t)?0:t}async function l(e){var t;let r=(0,o.getDbPool)();return t=(await r.query(`
    SELECT
      (
        SELECT COUNT(*)::text
        FROM transactions t
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f8db63e._.js.map